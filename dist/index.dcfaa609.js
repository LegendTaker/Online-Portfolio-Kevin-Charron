...
})({"bZmHb":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a8ba8c08dcfaa609";
"use strict";
...
},{}],"4Jp6w":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _locomotiveScroll = require("./node_modules/locomotive-scroll/src/locomotive-scroll");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"27GqH","./node_modules/locomotive-scroll/src/locomotive-scroll":"lE83F"}],"27GqH":[function(require,module,exports) {
...
},{}],"lE83F":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>(0, _mainDefault.default));
parcelHelpers.export(exports, "Native", ()=>(0, _nativeMain.Native));
parcelHelpers.export(exports, "Smooth", ()=>(0, _main.Smooth));
...
},{"./scripts/Main":"5hvdL","./scripts/NativeMain":"lHJ2s","@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"5hvdL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Smooth {
    constructor(options = {}){
        ...
        Object.assign(this, (0, _options.defaults), options);
        this.smartphone = (0, _options.defaults).smartphone;
        if (options.smartphone) Object.assign(this.smartphone, options.smartphone);
        this.tablet = (0, _options.defaults).tablet;
    ...
    init() {
        ...
        if (this.smooth && !this.options.isMobile || this.tablet.smooth && this.options.isTablet || this.smartphone.smooth && this.options.isMobile && !this.options.isTablet) this.scroll = new (0, _smoothDefault.default)(this.options);
        else this.scroll = new (0, _nativeDefault.default)(this.options);
        this.scroll.init();
...
},{"./options":"921bg","./Native":"1wSK4","./Smooth":"8NLkl","@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"921bg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"1wSK4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = class extends (0, _coreDefault.default) {
    constructor(options = {}){
        super(options);
        ...
        if (window.smoothscrollPolyfill === undefined) {
            window.smoothscrollPolyfill = (0, _smoothscrollPolyfillDefault.default);
...
},{"./Core":"46USk","smoothscroll-polyfill":"1W2LT","@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"46USk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _options = require("./options");
...
},{"./options":"921bg","@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"1W2LT":[function(require,module,exports) {
...
exports.default = class extends (0, _coreDefault.default) {
    ...
    updateScroll(e) {
        if (this.isScrolling || this.isDraggingScrollbar) this.instance.scroll[this.directionAxis] = (0, _maths.lerp)(this.instance.scroll[this.directionAxis], this.instance.delta[this.directionAxis], this.lerp);
        else {
     ...
     */ scrollTo(target, options = {}) {
        ...
        const callback = options.callback ? options.callback : false; // function called when scrollTo completes (note that it won't wait for lerp to stabilize)
        easing = (0, _bezierEasingDefault.default)(...easing);
        if (typeof target === "string") {
            // Selector or boundaries
        ...
        if (typeof target !== "number") {
            ...
            if (parentSection) parentSectionOffset = (0, _transform.getTranslate)(parentSection)[this.directionAxis]; // We got a parent section, store it's current offset to remove it later
...
},{"virtual-scroll":"kX6z8","./Core":"46USk","./utils/maths":"4gfKc","./utils/transform":"gzB1s","./utils/html":"fHFTb","bezier-easing":"jezh8","@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"kX6z8":[function(require,module,exports) {
"use strict";
var objectAssign = require("4b0c0957e2f064c9");
var Emitter = require("b209e2a00d0ef5c0");
var Lethargy = require("812753fb2f583796").Lethargy;
var support = require("60dd47c327fd6999");
var clone = require("c6ca7111f861dcb");
var bindAll = require("7ae85bb9fa8f015b");
...
},{"4b0c0957e2f064c9":"7OXxh","b209e2a00d0ef5c0":"2GwCf","812753fb2f583796":"1abQx","60dd47c327fd6999":"3eRJO","c6ca7111f861dcb":"2MwXX","7ae85bb9fa8f015b":"9DE6t"}],"7OXxh":[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"gzB1s":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"fHFTb":[function(require,module,exports) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}],"jezh8":[function(require,module,exports) {
/**
...
class Native {
    ...
    init() {
        this.scroll = new (0, _nativeDefault.default)(this.options);
        this.scroll.init();
        if (window.location.hash) {
            // Get the hash without the '#' and find the matching element
            const id = window.location.hash.slice(1, window.location.hash.length);
...
},{"./options":"921bg","./Native":"1wSK4","@parcel/transformer-js/src/esmodule-helpers.js":"27GqH"}]},["bZmHb","4Jp6w"], "4Jp6w", "parcelRequirecdc8")

//# sourceMappingURL=index.dcfaa609.js.map
